...
export interface ICreditScoreFheService {
  encryptCreditScore(score: bigint, userAddress: string): Promise<EncryptedValue>;
}

export class FheService implements IFheService, ICreditScoreFheService {
