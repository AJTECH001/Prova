import { CheckBridgeReadinessUseCase } from '../../../application/use-case/withdrawal/check-bridge-readiness.use-case.js';
...
const useCase = new CheckBridgeReadinessUseCase(container.withdrawalRepo);

const handler = createGetHandler({
  operationName: 'CheckBridgeReadiness',
