...
// src/infrastructure/auth/__tests__/nonce.service.test.ts
describe("NonceService", () => {
  ...
  describe("generateNonce", () => {
    it("returns a hex string of 64 characters", async () => {
      ...
      globalExpect(nonce).toMatch(/^[0-9a-f]{64}$/);
    });
    ...
    it("generates unique nonces on each call", async () => {
      ...
      globalExpect(nonce1).not.toBe(nonce2);
    });
  });
  describe("verifyNonce", () => {
    it("returns true for a valid nonce and deletes it", async () => {
      ...
      globalExpect(secondAttempt).toBe(false);
    });
...
@vitest/snapshot/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=nonce.service.test.js.map