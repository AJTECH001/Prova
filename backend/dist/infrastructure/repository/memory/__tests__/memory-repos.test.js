...
function requireReactIs_production_min() {
  ...
  var b2 = /* @__PURE__ */ Symbol.for("react.element"), c = /* @__PURE__ */ Symbol.for("react.portal"), d = /* @__PURE__ */ Symbol.for("react.fragment"), e = /* @__PURE__ */ Symbol.for("react.strict_mode"), f4 = /* @__PURE__ */ Symbol.for("react.profiler"), g = /* @__PURE__ */ Symbol.for("react.provider"), h4 = /* @__PURE__ */ Symbol.for("react.context"), k2 = /* @__PURE__ */ Symbol.for("react.server_context"), l2 = /* @__PURE__ */ Symbol.for("react.forward_ref"), m2 = /* @__PURE__ */ Symbol.for("react.suspense"), n2 = /* @__PURE__ */ Symbol.for("react.suspense_list"), p3 = /* @__PURE__ */ Symbol.for("react.memo"), q = /* @__PURE__ */ Symbol.for("react.lazy"), t = /* @__PURE__ */ Symbol.for("react.offscreen"), u3;
  u3 = /* @__PURE__ */ Symbol.for("react.module.reference");
  function v2(a3) {
...
function diff(a3, b2, options) {
  ...
  if (aType === "object" && typeof a3.asymmetricMatch === "function") {
    if (a3.$$typeof !== /* @__PURE__ */ Symbol.for("jest.asymmetricMatcher")) {
      return void 0;
    }
...
// ../node_modules/.pnpm/vitest@3.2.4_@edge-runtime+vm@3.2.0_@types+node@22.19.17_jiti@2.6.1_jsdom@26.1.0_lightn_b99cb9550bcf9f636d17b81a6f1f30d8/node_modules/vitest/dist/chunks/utils.XdZDrNZV.js
...
// ../node_modules/.pnpm/vitest@3.2.4_@edge-runtime+vm@3.2.0_@types+node@22.19.17_jiti@2.6.1_jsdom@26.1.0_lightn_b99cb9550bcf9f636d17b81a6f1f30d8/node_modules/vitest/dist/chunks/_commonjsHelpers.BFTU3MAI.js
...
// ../node_modules/.pnpm/vitest@3.2.4_@edge-runtime+vm@3.2.0_@types+node@22.19.17_jiti@2.6.1_jsdom@26.1.0_lightn_b99cb9550bcf9f636d17b81a6f1f30d8/node_modules/vitest/dist/chunks/date.Bq6ZW5rf.js
var RealDate = Date;
var now2 = null;
...
// ../node_modules/.pnpm/vitest@3.2.4_@edge-runtime+vm@3.2.0_@types+node@22.19.17_jiti@2.6.1_jsdom@26.1.0_lightn_b99cb9550bcf9f636d17b81a6f1f30d8/node_modules/vitest/dist/chunks/vi.bdSIJ99Y.js
var unsupported = [
  "matchSnapshot",
  "toMatchSnapshot",
...
// ../node_modules/.pnpm/vitest@3.2.4_@edge-runtime+vm@3.2.0_@types+node@22.19.17_jiti@2.6.1_jsdom@26.1.0_lightn_b99cb9550bcf9f636d17b81a6f1f30d8/node_modules/vitest/dist/index.js
var import_expect_type = __toESM(require_dist(), 1);

// src/infrastructure/repository/memory/__tests__/memory-repos.test.ts
...
var MemorySessionRepository = class {
  ...
  async findByUserId(userId) {
    return [...this.store.values()].filter((s2) => s2.userId === userId);
  }
  async save(session) {
...
var MemoryEscrowRepository = class {
  ...
  async findByUserId(userId, options) {
    let items = [...this.store.values()].filter((i) => i.userId === userId).filter((i) => options?.status ? i.status === options.status : true).sort((a3, b2) => b2.createdAt.getTime() - a3.createdAt.getTime());
    if (options?.cursor) {
...
var MemoryWithdrawalRepository = class {
  ...
  async findByUserId(userId, options) {
    let items = [...this.store.values()].filter((w2) => w2.userId === userId).filter((w2) => options?.status ? w2.status === options.status : true).sort((a3, b2) => b2.createdAt.getTime() - a3.createdAt.getTime());
    if (options?.cursor) {
      const cursorIndex = items.findIndex((w2) => w2.publicId === options.cursor);
      if (cursorIndex !== -1) {
        items = items.slice(cursorIndex + 1);
      }
    }
...
function makeEscrow(userId, overrides = {}) {
  return new Escrow({
    id: randomUUID(),
    publicId: randomUUID(),
    userId,
...
function makeWithdrawal(userId, overrides = {}) {
...
describe("MemoryUserRepository", () => {
  ...
  it("save and findById returns the saved user", async () => {
    ...
    globalExpect(found2).toEqual(user);
  });
  it("findById returns null for unknown id", async () => {
    globalExpect(await repo.findById("nope")).toBeNull();
  });
  it("findByWalletAddress returns matching user", async () => {
    const user = makeUser({ walletAddress: "0xunique" });
    await repo.save(user);
    const found2 = await repo.findByWalletAddress("0xunique");
    globalExpect(found2?.id).toBe(user.id);
  });
  it("findByWalletAddress returns null when not found", async () => {
    globalExpect(await repo.findByWalletAddress("0xmissing")).toBeNull();
  });
});
describe("MemorySessionRepository", () => {
  ...
  it("save and findById returns session", async () => {
    ...
    globalExpect(await repo.findById(session.id)).toEqual(session);
  });
  it("findById returns null for unknown id", async () => {
    globalExpect(await repo.findById("nope")).toBeNull();
  });
  it("findByRefreshToken returns matching session", async () => {
    ...
    await repo.save(session);
    const found2 = await repo.findByRefreshToken("special-token");
    globalExpect(found2?.id).toBe(session.id);
  });
  it("findByRefreshToken returns null when not found", async () => {
    globalExpect(await repo.findByRefreshToken("missing")).toBeNull();
  });
  it("findByUserId returns all sessions for a user", async () => {
    ...
    globalExpect(sessions).toHaveLength(2);
  });
  it("delete removes a session by id", async () => {
    const session = makeSession(userId);
    await repo.save(session);
    await repo.delete(session.id);
    globalExpect(await repo.findById(session.id)).toBeNull();
  });
  it("deleteByUserId removes all sessions for the user", async () => {
    ...
    globalExpect(await repo.findByUserId(userId)).toHaveLength(0);
  });
});
describe("MemoryEscrowRepository", () => {
  ...
  it("save and findById returns escrow", async () => {
    ...
    globalExpect(await repo.findById(escrow.id)).toEqual(escrow);
  });
  it("findByPublicId returns matching escrow", async () => {
    const escrow = makeEscrow(userId);
    await repo.save(escrow);
    globalExpect(await repo.findByPublicId(escrow.publicId)).toEqual(escrow);
  });
  it("findByPublicId returns null when not found", async () => {
    globalExpect(await repo.findByPublicId("missing")).toBeNull();
  });
  it("update persists changes", async () => {
    ...
    globalExpect(updated?.status).toBe("ON_CHAIN" /* ON_CHAIN */);
  });
  it("findByUserId returns escrows for user sorted by createdAt desc", async () => {
    const i1 = makeEscrow(userId, { createdAt: /* @__PURE__ */ new Date("2024-01-01") });
    const i2 = makeEscrow(userId, { createdAt: /* @__PURE__ */ new Date("2024-06-01") });
    await repo.save(i1);
    await repo.save(i2);
    const result = await repo.findByUserId(userId);
    globalExpect(result.items[0].id).toBe(i2.id);
    globalExpect(result.items[1].id).toBe(i1.id);
  });
  it("findByUserId filters by status", async () => {
    const pending = makeEscrow(userId, { status: "PENDING" /* PENDING */ });
    const settled = makeEscrow(userId, { status: "SETTLED" /* SETTLED */ });
    await repo.save(pending);
    await repo.save(settled);
    const result = await repo.findByUserId(userId, { status: "SETTLED" /* SETTLED */ });
    globalExpect(result.items).toHaveLength(1);
    globalExpect(result.items[0].status).toBe("SETTLED" /* SETTLED */);
  });
  it("findByUserId respects limit and returns cursor when has_more", async () => {
    ...
    globalExpect(result.items).toHaveLength(3);
    globalExpect(result.cursor).toBeDefined();
  });
  it("findByUserId uses cursor to paginate", async () => {
    ...
    globalExpect(second.items).toHaveLength(2);
    globalExpect(second.items[0].id).not.toBe(first.items[0].id);
  });
  it("findByTxHash returns matching escrow", async () => {
    const escrow = makeEscrow(userId, { txHash: "0xtxhash" });
    await repo.save(escrow);
    globalExpect(await repo.findByTxHash("0xtxhash")).toEqual(escrow);
  });
  it("findByTxHash returns null when not found", async () => {
    globalExpect(await repo.findByTxHash("0xmissing")).toBeNull();
  });
  it("findByOnChainId returns matching escrow", async () => {
    const escrow = makeEscrow(userId, { onChainEscrowId: "42" });
    await repo.save(escrow);
    globalExpect(await repo.findByOnChainId("42")).toEqual(escrow);
  });
  it("findByOnChainId returns null when not found", async () => {
    globalExpect(await repo.findByOnChainId("999")).toBeNull();
  });
});
describe("MemoryWithdrawalRepository", () => {
  ...
  it("save and findById returns withdrawal", async () => {
    const w2 = makeWithdrawal(userId);
    await repo.save(w2);
    globalExpect(await repo.findById(w2.id)).toEqual(w2);
  });
  it("findByPublicId returns matching withdrawal", async () => {
    const w2 = makeWithdrawal(userId);
    await repo.save(w2);
    globalExpect(await repo.findByPublicId(w2.publicId)).toEqual(w2);
  });
  it("findByPublicId returns null when not found", async () => {
    globalExpect(await repo.findByPublicId("WD-MISSING")).toBeNull();
  });
  it("update persists status changes", async () => {
    const w2 = makeWithdrawal(userId);
    await repo.save(w2);
    w2.markRedeemComplete("0xtx");
    await repo.update(w2);
    const updated = await repo.findById(w2.id);
    globalExpect(updated?.status).toBe("PENDING_BRIDGE" /* PENDING_BRIDGE */);
  });
  ...
  it("findByUserId filters by status", async () => {
    const pending = makeWithdrawal(userId, { status: "PENDING_REDEEM" /* PENDING_REDEEM */ });
    const completed = makeWithdrawal(userId, { status: "COMPLETED" /* COMPLETED */ });
    await repo.save(pending);
    await repo.save(completed);
    const result = await repo.findByUserId(userId, { status: "COMPLETED" /* COMPLETED */ });
    globalExpect(result.items).toHaveLength(1);
  });
});
describe("MemoryBusinessProfileRepository", () => {
  ...
  it("save and findByUserId returns profile", async () => {
    ...
    globalExpect(await repo.findByUserId(userId)).toEqual(profile);
  });
  it("findByUserId returns null when not found", async () => {
    globalExpect(await repo.findByUserId("nobody")).toBeNull();
  });
});
describe("MemoryApiCredentialRepository", () => {
  ...
  function makeCredential(userId) {
  ...
  it("save and findByClientId returns credential", async () => {
    ...
    globalExpect(await repo.findByClientId(credential.clientId)).toEqual(credential);
  });
  it("findByClientId returns null when not found", async () => {
    globalExpect(await repo.findByClientId("rc_missing")).toBeNull();
  });
  ...
  it("update persists status change", async () => {
    ...
    globalExpect(updated?.status).toBe("revoked");
  });
});
describe("MemoryEscrowEventRepository", () => {
  ...
  function makeEvent(txHash, escrowId) {
  ...
  it("save and findByTxHash returns event", async () => {
    ...
    globalExpect(await repo.findByTxHash("0xtx1")).toEqual(event);
  });
  it("findByTxHash returns null when not found", async () => {
    globalExpect(await repo.findByTxHash("0xmissing")).toBeNull();
  });
  it("findByEscrowId returns matching event", async () => {
    ...
    await repo.save(event);
    globalExpect(await repo.findByEscrowId("escrow-999")).toEqual(event);
  });
  it("findByEscrowId returns null when not found", async () => {
    globalExpect(await repo.findByEscrowId("nope")).toBeNull();
  });
  it("delete removes event by txHash", async () => {
    const event = makeEvent("0xtx3", "escrow-3");
    await repo.save(event);
    await repo.delete("0xtx3");
    globalExpect(await repo.findByTxHash("0xtx3")).toBeNull();
  });
});
describe("MemoryNonceRepository", () => {
  ...
  it("save and findAndDelete returns true for valid entry", async () => {
    ...
    globalExpect(await repo.findAndDelete("0xwallet", "mynonce")).toBe(true);
  });
  it("findAndDelete returns false after nonce is consumed", async () => {
    await repo.save("0xwallet", "mynonce", 300);
    await repo.findAndDelete("0xwallet", "mynonce");
    globalExpect(await repo.findAndDelete("0xwallet", "mynonce")).toBe(false);
  });
  it("findAndDelete returns false for unknown nonce", async () => {
    globalExpect(await repo.findAndDelete("0xwallet", "unknown")).toBe(false);
  });
  it("findAndDelete returns false for expired nonce", async () => {
    await repo.save("0xwallet", "expired", -1);
    globalExpect(await repo.findAndDelete("0xwallet", "expired")).toBe(false);
  });
});
...
@vitest/snapshot/dist/index.js:
   ...
   *)
*/
//# sourceMappingURL=memory-repos.test.js.map