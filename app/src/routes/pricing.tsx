          ...
          <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
              ...
              <div className="flex flex-col rounded-2xl border border-[hsl(var(--ds-line-light))] bg-white p-10">
                <p className="mb-3 text-xs font-bold uppercase tracking-[0.18em] text-[hsl(var(--ds-ink-400))]">
                  For sellers
                </p>
                <h2 className="mb-2 text-3xl font-black tracking-tight text-[hsl(var(--ds-ink-900))]">
                  Coverage premium
                </h2>
                ...
                <div className="mb-8 rounded-xl border border-[hsl(var(--ds-line-light))] bg-[hsl(var(--ds-surface-section))] p-6">
                  <div className="flex items-end gap-1.5">
                    <span className="text-5xl font-black text-[hsl(var(--ds-ink-900))]">0.5</span>
                    <span className="mb-2 text-xl font-bold text-[hsl(var(--ds-ink-400))]">– 5%</span>
                  </div>
